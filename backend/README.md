...
## Project Structure
    ...
    ├── testapiautoteammemb_85214  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_85214`
...
2. Clone this repo and `cd testapiautoteammemb_85214`
